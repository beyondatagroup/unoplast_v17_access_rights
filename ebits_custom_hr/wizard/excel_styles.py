...
subTitle_style = xlwt.easyxf('font: height 200, name Arial, colour_index black, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1B')
...
g_style = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
...
gtn_style = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
...
normal_style_center = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert bottom, horiz centre;')
...
class ExcelStyles(object):
    ...
    def normal_center(self):
        normal_style_center.borders = borders
        return  normal_style_center

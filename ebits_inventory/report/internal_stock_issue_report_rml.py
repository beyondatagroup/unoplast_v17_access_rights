...
class InternalStockIssueRmlReport(report_sxw.rml_parse):
    def set_context(self, objects, data, ids, report_type = None):
        super(InternalStockIssueRmlReport,self).set_context(objects, data, ids, report_type)
...
report_sxw.report_sxw('report.internal.stock.issue.rml.report', 'internal.stock.transfer.issue',
      'addons/ebits_inventory/report/internal_stock_issue_report_rml.rml', parser=InternalStockIssueRmlReport, header=False)

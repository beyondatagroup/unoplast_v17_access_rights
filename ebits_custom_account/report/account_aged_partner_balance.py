...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_selected_partner_move_lines(self, account_type, date_from, target_move, period_length, partner_bro_ids):
        periods = {}
        start = datetime.strptime(date_from, "%Y-%m-%d")
        for i in range(5)[::-1]:
            stop = start - relativedelta(days=period_length)
    ...
    def render_html(self, docids, data=None):
        ...
        if data['form']['partner_ids']:
            ...
            movelines, total, dummy = self._get_selected_partner_move_lines(account_type, date_from, target_move, data['form']['period_length'], partner_ids)
        else:

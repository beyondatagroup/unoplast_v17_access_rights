...
g_style_ice_blue = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour ice_blue')
g_style_tan = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour tan')
...
normal_style_right_color = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert bottom, horiz right;' 'pattern: pattern solid, fore_colour 0x1b')
...
normal_style_right_ice_blue_center = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert bottom, horiz centre;' 'pattern: pattern solid, fore_colour ice_blue')
...
class ExcelStyles(object):
    ...
    def normal_right_ice_blue_center(self):
        normal_style_right_ice_blue_center.borders = borders
        return  normal_style_right_ice_blue_center
    ...
    def groupByTitleIb(self):
        g_style_ice_blue.borders = borders
        return g_style_ice_blue
    
    def groupByTitleTan(self):
        g_style_tan.borders = borders
        return g_style_tan

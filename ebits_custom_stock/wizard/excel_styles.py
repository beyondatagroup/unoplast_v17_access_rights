...
tittle_style_color = xlwt.easyxf('font: height 240, bold on; align: wrap on, vert centre, horiz center;' 'pattern: pattern solid, fore_colour 0x1B')
...
subTitle_style_color = xlwt.easyxf('font: height 200, bold on, italic on; align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
...
subTitle_style_sub_color_left = xlwt.easyxf('font: height 240, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1A')
...
subTitle_style_left_color = xlwt.easyxf('font: height 200, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour ice_blue')
...
normal_style_right_color = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert bottom, horiz right;' 'pattern: pattern solid, fore_colour ice_blue')

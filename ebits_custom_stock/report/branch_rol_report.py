...
class BranchRolReport(models.Model):
    _name = "branch.rol.report"
    _description = "Branch Reordering Rules Report"
    _auto = False

    product_id = fields.Many2one('product.product', 'Product', readonly=True)
    categ_id = fields.Many2one('product.category', 'Product Category', readonly=True)
    uom_id = fields.Many2one('uom.uom', 'UOM', readonly=True)
    warehouse_id = fields.Many2one('stock.warehouse', 'Branch', readonly=True)

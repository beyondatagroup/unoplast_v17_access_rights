...
class StockPickingInPackRmlReport(report_sxw.rml_parse):
    def set_context(self, objects, data, ids, report_type = None):
        super(StockPickingInPackRmlReport,self).set_context(objects, data, ids, report_type)
...
report_sxw.report_sxw('report.stock.picking.in.pack.rml.report', 'stock.picking',
      'addons_ebits/ebits_custom_stock/report/stock_picking_pack_rml_report.rml', parser=StockPickingInPackRmlReport, header=False)

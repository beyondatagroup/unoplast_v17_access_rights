...
class StockPickingPurchaseReportRmlReport(report_sxw.rml_parse):
    def set_context(self, objects, data, ids, report_type = None):
        super(StockPickingPurchaseReportRmlReport,self).set_context(objects, data, ids, report_type)
...
report_sxw.report_sxw('report.stock.picking.purchase.return.rml.report', 'stock.picking',
      'addons_ebits/ebits_custom_stock/report/stock_picking_purchase_return_rml_report.rml', parser=StockPickingPurchaseReportRmlReport, header=False)

...
tittle_style = xlwt.easyxf(
    'font: height 240, name Arial, colour_index white, bold on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x3C')
...
class ExcelStyles(object):
    ...
    def normal_num_right(self):
        ...
        normal_style_right.num_format_str = '########0.00'
        return normal_style_right
    def normal_num_left(self):
        normal_style_left.borders = borders
        normal_style_left.num_format_str = '########0.00'
        return normal_style_left
    ...
    def normal_num_right_3digits(self):
        ...
        return normal_style_right
    def normal_num_left_3digits(self):
        normal_style_left.borders = borders
        normal_style_left.num_format_str = '########0.000'
        return normal_style_left
